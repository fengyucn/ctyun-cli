...
| 版本号 | 发布日期 | 主要变更 |
|--------|----------|----------|
| 1.6.0 | 2025-12-03 | VPC模块全面升级，实现new系列API和showVpc功能 |
| 1.5.0 | 2025-12-02 | 账单模块全面升级，实现10个账单API完整体系 |
| 1.4.12 | 2025-11-28 | 新增IAM分页查询资源信息API，增强资源字段显示 |
| 1.4.0 | 2025-11-27 | Redis功能全面升级，支持完整25+API参数 |
