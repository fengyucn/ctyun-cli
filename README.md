...
**新增功能亮点 (v1.3.11)：**
- 🔥 **CCE任务管理** - 新增容器集群任务查询API，支持任务状态、类型、内容等详细信息
...
**重大更新 v1.3.11 - CCE任务管理功能：**

- 🔥 **新增CCE任务查询API** - 支持容器集群任务列表查询，包含任务状态、类型、内容等详细信息
...
**2025-12-02 新增CDA模块14个命令，19个API：**
...
- ⭐ 云专线健康检查配置查询 - 配置参数和监控策略
- ⭐ 查询专线网关已绑定的物理专线 - 物理专线绑定关系
- ⭐ 查询BGP路由 - BGP路由表详细信息
- ⭐ 查询跨账号授权 - 跨账号权限管理
- ⭐ 统计跨账号授权 - 授权数量统计
- ⭐ 专线网关管理 - 列表、统计、物理专线、云间高速查询
- ⭐ VPC管理 - 列表、统计、详情查询
- ⭐ 物理专线管理 - 列表、接入点、统计查询
- ⭐ 路由管理 - 静态路由、BGP路由查询
