...
[![APIs](https://img.shields.io/badge/APIs-851+-brightgreen.svg)](docs/MODULES/README.md#api统计)
[![Commands](https://img.shields.io/badge/Commands-806+-orange.svg)](docs/MODULES/README.md#命令统计)
...
| **总计** | **806** | **851** | **覆盖天翼云核心服务** | [所有模块](docs/MODULES/) |

📊 **规模统计：61,000+行代码，851+个API，806+个命令，27大服务模块**
...
**v1.27.5** (2026-07-24)
- 🔧 **ECS 模块清理与修复**：移除 3 个旧版 mock 命令，修复 `console` 对接真实 VNC API，启用可用区详情查询

**v1.27.4** (2026-07-24)
- 🐛 **Bug 修复**：DPS / EMR / Kafka 模块输出不再截断实例 ID 与子网 ID

**v1.27.3** (2026-07-24)
- 🐛 **Bug 修复**：`regions` 命令不再截断 regionID，输出完整 ID

**v1.27.2** (2026-07-23)
- 🚀 **VPC 模块新增 14 个命令**：网络诊断、DHCP、私有DNS关联VPC、IPv6网关/带宽、IPv4网关

**v1.27.1** (2026-07-23)
- 🚀 **VPC 模块新增 14 个命令**：网络ACL、前缀列表、流日志、网关负载均衡、二层网关、高可用VIP

**v1.27.0** (2026-07-23)
- 🚀 **VPC 模块新增 20 个命令**：弹性公网IP监控/备案、带宽、流量包、终端节点/服务、私有DNS及记录管理

**v1.26.2** (2026-07-21)
- 🚀 **VPC 模块新增 13 个命令**：NAT 网关、SNAT/DNAT、对等连接、路由表、安全组规则、端口管理
